...
export const clients: Client[] = [
  ...
  // SMS schools: the repo only records arms ("Western", "Kulliyyah") and one real
  // database used in an upgrade rehearsal. Shuaibu to supply the school names.
  { name: "Late Yusuf Memorial School", type: "School", city: "Kano", product: "Asyyl SMS", confirm: true },
...
export const clientSummary = {
  headline: "Five businesses in Kano and Abuja run their tills and ledgers on Asyyl BMS. Schools in Kano run their bursary and results on Asyyl SMS.",
};

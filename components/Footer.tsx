...
export function Footer() {
  return (
    <footer data-tone="dark" className="border-t border-line py-16 md:py-20">
      <Container className="grid gap-12">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <p className="text-small text-ink-2">{site.footer.comingSoon}</p>
        </div>
        <div className="flex flex-col gap-8 border-t border-line pt-8 md:flex-row md:items-center md:justify-between">
          ...
          <p className="text-small text-ink-2">{site.footer.copyright}</p>
        </div>
      </Container>
    </footer>
  );
